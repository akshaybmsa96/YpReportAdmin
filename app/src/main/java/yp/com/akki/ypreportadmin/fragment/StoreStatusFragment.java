...
import yp.com.akki.ypreportadmin.adapter.CustomAdapterStoreStatus;
...
public class StoreStatusFragment extends Fragment {
    ...
    private CustomAdapterStoreStatus customAdapterStoreStatus;


    public StoreStatusFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_store_status, container, false);
        ...
        call.enqueue(new Callback<ArrayList<StorePojo>>() {
            ...
            public void onResponse(Call<ArrayList<StorePojo>> call, Response<ArrayList<StorePojo>> response) {
                ...
                if(storePojo!=null&&storePojo.size()>0) {
                    ...
                    customAdapterStoreStatus = new CustomAdapterStoreStatus(getContext(),storePojo,getActivity());
                    recyclerView.setHasFixedSize(true);
                    recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
                    recyclerView.setAdapter(customAdapterStoreStatus);
